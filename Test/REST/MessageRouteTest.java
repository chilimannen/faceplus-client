...
public class MessageRouteTest implements MessageManagerClient {
    ...
    private void message(MessageMapping message) {
         REST.getClient()
                ...
                .request(REST.TYPE)
                .post(Entity.entity(message, REST.TYPE), RequestMapping.class);
    }
    ...
    public PostList getMessages(RequestMapping account, String from) throws FriendException, AuthenticationException {
