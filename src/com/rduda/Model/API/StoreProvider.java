...
public interface StoreProvider {
     ...
     */
    Post getPostModel(Account sender, String receiver, String content, String date);

    /**
     * Instantiate a message using the provider-hidden implementation.
     *
     * @param sender   Account sending the message.
     * @param target Username of Account receiving the message.
     * @param content  The textual content of the message.
     * @return an object implementing the Message interface.
     */
    Message getMessageModel(Account sender, String target, String content);
}
